...
def parse_options():
    ...
    parser = optparse.OptionParser("python heatmap.py --pbm=pbm_dir --pdb=pdb_dir [--dummy=dummy_dir -f folds -o output_dir -r randoms --start=start_step --stop=stop_step -v]")
